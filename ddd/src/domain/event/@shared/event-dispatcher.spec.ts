...
import SendFirstMessageWhenCustomerIsCreatedHandler from "../customer/handlers/send-first-message-when-customer-is-created.handler";
import SendSecondMessageWhenCustomerIsCreatedHandler from "../customer/handlers/send-second-message-when-customer-is-created.handler";
import SendMessageWhenCustomerAddressIsChangedHandler from "../customer/handlers/send-message-when-customer-addresss-is-changed.handler";
